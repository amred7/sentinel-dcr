...
$tenantId = "cf1f2488-2927-4277-9cce-abadaab0a616"; #the tenant ID in which the Data Collection Endpoint resides
$appId = "nYj7Q~r53I42u45eAMiPNjfD2yIxa0LFQ_Kg3"; #the app ID created and granted permissions
$appSecret = "8e3d11dd-1e29-4d39-bb48-b87d43bbe5a9"; #the secret created for the above app - never store your secrets in the source code
##### >>>> END <<<<<
